...
class TicTacToe(Game):
    ...
    def __init__(self, h=3, v=3, k=3, p=None):
        update(self, h=h, v=v, k=k, p=None)
        moves = [(x, y) for x in range(1, h+1)
                 for y in range(1, v+1)]
        self.initial = Struct(to_move=p, utility=0, board={}, moves=moves)
...
class ConnectFour(TicTacToe):
    ...
    def __init__(self, h=7, v=6, k=4, p=None):
        TicTacToe.__init__(self, h, v, k, p)
